...
class GamesTableViewCell: UITableViewCell {
    ...
    let favoriteButton: UIButton = {
        let view = UIButton()
        let iconLeft = UIImage(named: "plus")
        ...
        view.setTitleColor(UIColor.darkText, for: .highlighted)
        view.setTitle("Favorite", for: .normal)
        view.setTitle("Add To Favorite", for: .highlighted)
        view.titleLabel?.font = UIFont.systemFont(ofSize: 12)
        view.layer.borderWidth = 1
        view.layer.borderColor = CGColor.init(red: 2/255, green: 122/255, blue: 255/255, alpha: 1)
